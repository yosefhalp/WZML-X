...
async def gen_pyro_string(_, message):
    ...
    while True:
        ...
        await edit_message(
            sess_msg,
            f"{h}\n┃\n{c_phone}\n┃\n"
            f"┃ האם המספר <code>{phone_no}</code> נכון?\n"
            "┖ <b>שלחו:</b> <code>y</code> / <code>yes</code> לאישור, או <code>n</code> / <code>no</code> לתיקון.",
            btns,
        )
    ...
    try:
        pyro_client = Client(
            ...
            api_hash=api_hash,
            workdir="/usr/src/app",
            app_version=f"WZML-X HE {get_version()}",
    ...
    try:
        ...
        await pyro_client.send_message(
            ...
            "<b>נוצר באמצעות <a href='https://github.com/yosefhalp/WZML-X'>WZML-X HE של יוסף</a></b>",
