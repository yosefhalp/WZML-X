...
DEFAULT_DESP = {
    ...
    "GOFILE_ZONE": "אזור מועדף לבחירת שרת העלאה של GoFile. ברירת המחדל: eu.",
    ...
    "AUTHOR_NAME": "שם היוצר שמוצג בדפי Telegraph.",
    "AUTHOR_URL": "הקישור של היוצר שמוצג בדפי Telegraph.",
    ...
    "YT_DESP": "תיאור ברירת המחדל להעלאות YouTube.",
...
CONFIG_DESCRIPTIONS_HE = {
    "BOT_TOKEN": "טוקן הבוט שקיבלתם מ־@BotFather.",
    "OWNER_ID": "מזהה המשתמש של בעל הבוט ב־Telegram.",
    "TELEGRAM_API": "מזהה API של Telegram מאתר my.telegram.org.",
    "TELEGRAM_HASH": "מפתח API Hash של Telegram מאתר my.telegram.org.",
    "DATABASE_URL": "מחרוזת חיבור ל־MongoDB לצורך שמירת הגדרות ומצב.",
    "DEFAULT_LANG": "קוד שפת ברירת המחדל. בגרסה הזאת ברירת המחדל היא he.",
    "AUTHORIZED_CHATS": "מזהי משתמשים או צ׳אטים המורשים להשתמש בבוט, מופרדים ברווח.",
    "SUDO_USERS": "מזהי מנהלים נוספים, מופרדים ברווח.",
    "BASE_URL": "הכתובת הציבורית של ממשק בחירת קבצי הטורנט.",
    "WEB_ACCESS_PASSWORD": "סוד קבוע שממנו נגזרות סיסמאות ממשקי הניהול. אין לשתף אותו.",
    "WEB_PINCODE": "האם לדרוש קוד גישה בממשק בחירת הקבצים.",
    "DEFAULT_UPLOAD": "יעד העלאה ברירת מחדל: rc עבור Rclone או gd עבור Google Drive.",
    "GDRIVE_ID": "מזהה תיקיית היעד ב־Google Drive.",
    "INDEX_URL": "כתובת האינדקס של Google Drive ליצירת קישורים ישירים.",
    "RCLONE_PATH": "נתיב ברירת המחדל להעלאות Rclone, לדוגמה remote:folder.",
    "RCLONE_FLAGS": "אפשרויות נוספות ל־Rclone בתבנית key:value|key.",
    "GOFILE_API": "טוקן API של GoFile עבור העלאות ישירות.",
    "GOFILE_FOLDER_ID": "מזהה תיקיית היעד ב־GoFile. אפשר להשאיר ריק לתיקייה הראשית.",
    "GOFILE_ZONE": "אזור שרת מועדף ב־GoFile. ברירת המחדל eu מתאימה לפריסה באירופה.",
    "GOFILE_AUTO_CREATE_FOLDER": "האם ליצור אוטומטית תיקייה חדשה לכל העלאה ב־GoFile.",
    "JD_EMAIL": "כתובת הדוא״ל של חשבון JDownloader.",
    "JD_PASS": "סיסמת חשבון JDownloader.",
    "MEGA_EMAIL": "כתובת הדוא״ל של חשבון Mega.",
    "MEGA_PASSWORD": "סיסמת חשבון Mega.",
    "USENET_SERVERS": "רשימת שרתי Usenet במבנה של מילונים.",
    "STATUS_UPDATE_INTERVAL": "מספר השניות בין רענוני הודעת הסטטוס.",
    "STATUS_LIMIT": "מספר המשימות המרבי שיוצג בכל עמוד סטטוס.",
    "BOT_MAX_TASKS": "מספר המשימות הכולל שהבוט יריץ במקביל. 0 פירושו ללא הגבלה.",
    "USER_MAX_TASKS": "מספר המשימות המרבי לכל משתמש. 0 פירושו ללא הגבלה.",
    "QUEUE_ALL": "מגבלה כוללת על הורדות והעלאות פעילות. 0 פירושו ללא הגבלה.",
    "QUEUE_DOWNLOAD": "מספר ההורדות המרבי במקביל. 0 פירושו ללא הגבלה.",
    "QUEUE_UPLOAD": "מספר ההעלאות המרבי במקביל. 0 פירושו ללא הגבלה.",
    "LEECH_SPLIT_SIZE": "גודל כל חלק שנשלח ל־Telegram, בבייטים.",
    "LEECH_DUMP_CHAT": "מזהה הצ׳אט שאליו יישלחו קובצי Telegram.",
    "LEECH_PREFIX": "טקסט שיופיע לפני שמות הקבצים.",
    "LEECH_SUFFIX": "טקסט שיופיע אחרי שמות הקבצים.",
    "LEECH_CAPTION": "כיתוב מותאם לקבצים שנשלחים ל־Telegram.",
    "EXCLUDED_EXTENSIONS": "סיומות קבצים שלא יועלו, מופרדות ברווח וללא נקודה.",
    "YT_DLP_OPTIONS": "אפשרויות ברירת מחדל של yt-dlp במבנה מילון.",
    "YT_DESP": "תיאור ברירת המחדל להעלאות YouTube.",
    "YT_TAGS": "תגיות ברירת המחדל להעלאות YouTube.",
    "YT_PRIVACY_STATUS": "מצב הפרטיות של העלאות YouTube: public, unlisted או private.",
    "DISABLE_TORRENTS": "השבתת כל הורדות הטורנטים.",
    "DISABLE_LEECH": "השבתת שליחת קבצים ל־Telegram.",
    "DISABLE_JD": "השבתת JDownloader וחיסכון בזיכרון.",
    "DISABLE_NZB": "השבתת SABnzbd ו־Usenet וחיסכון בזיכרון.",
    "DISABLE_RSS": "השבתת ניטור RSS.",
    "DISABLE_SEARCH": "השבתת חיפוש טורנטים.",
    "DISABLE_YTDLP": "השבתת הורדות yt-dlp.",
    "TIMEZONE": "אזור הזמן להצגת תאריכים ושעות, לדוגמה Asia/Jerusalem.",
    "UPSTREAM_REPO": "כתובת מאגר Git שממנו הבוט יקבל עדכונים.",
    "UPSTREAM_BRANCH": "הענף שממנו הבוט יקבל עדכונים.",
}


def get_config_description(key):
    """מחזיר הסבר עברי ברור גם למשתנה מתקדם שאין לו תיאור ייעודי."""

    return CONFIG_DESCRIPTIONS_HE.get(
        key,
        f"הגדרה מתקדמת בשם {key}. יש לשנות אותה רק כאשר ידוע הערך הנדרש.",
    )
...
async def get_buttons(key=None, edit_type=None, edit_mode=False):
    buttons = ButtonMaker()
    if key is None:
        buttons.data_button("🧩 משתני מערכת", "botset var")
        buttons.data_button("🔌 הפעלת רכיבים", "botset setonoff")
        buttons.data_button("🔐 קבצים פרטיים", "botset private open")
        buttons.data_button("🧲 הגדרות qBittorrent", "botset qbit")
        buttons.data_button("⬇️ הגדרות Aria2", "botset aria")
        buttons.data_button("📰 הגדרות SABnzbd", "botset nzb")
        buttons.data_button("🔄 סנכרון JDownloader", "botset syncjd")
        buttons.data_button("סגירה", "botset close", style=ButtonStyle.DANGER)
        msg = "<b>⚙️ הגדרות הבוט</b>\n\nבחרו את קבוצת ההגדרות שברצונכם לנהל."
        ...
        if edit_type == "ariavar":
            ...
            msg = (
                "<i>שלחו מפתח וערך.</i> לדוגמה: <code>https-proxy-user:value</code>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
                if key == "newkey"
                else f"<i>שלחו ערך תקין עבור <code>{key}</code>.</i> הערך הנוכחי הוא <code>{aria2_options[key]}</code>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
            )
            ...
            buttons.data_button("Close", "botset close", style=ButtonStyle.DANGER)
            msg = f"<i>שלחו ערך תקין עבור <code>{key}</code>.</i> הערך הנוכחי הוא <code>{qbit_options[key]}</code>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
            ...
            buttons.data_button("Close", "botset close", style=ButtonStyle.DANGER)
            msg = f"<i>שלחו ערך תקין עבור <code>{key}</code>.</i> הערך הנוכחי הוא <code>{nzb_options[key]}</code>\nאם הערך הוא רשימה, הפרידו באמצעות רווח או פסיק.\nלדוגמה: <code>.exe,info</code> או <code>.exe .info</code>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
            ...
            buttons.data_button("Close", "botset close", style=ButtonStyle.DANGER)
            if key == "newser":
                msg = "<i>שלחו שרת אחד כמילון <code>{}</code>, בדומה ל־config.py אך ללא <code>[]</code>.</i>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
            else:
                msg = f"<i>שלחו ערך תקין עבור <code>{key}</code> בשרת <code>{Config.USENET_SERVERS[index]['name']}</code>.</i> הערך הנוכחי הוא <code>{Config.USENET_SERVERS[index][key]}</code>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
        elif edit_type == "editvar":
            msg = f"<b>משתנה:</b> <code>{key}</code>\n\n"
            msg += f"<b>הסבר:</b> {get_config_description(key)}\n\n"
            value = Config.get(key)
            if value == "":
                value = "לא הוגדר"
            msg += f"<b>ערך נוכחי:</b> <code>{value}</code>\n\n"
            buttons.data_button(
            ...
            if key not in BOOL_VARS:
                ...
                msg += "<i>בחרו ערך תקין עבור המשתנה.</i>\n\n"
            ...
            if edit_mode and key in RESTART_VARS:
                msg += (
                    "\n<b>שימו לב:</b> יש להפעיל מחדש את הבוט כדי שהשינוי ייכנס לתוקף.\n\n"
                )
            if edit_mode and key not in BOOL_VARS:
                msg += "<i>שלחו ערך תקין עבור המשתנה.</i>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
    elif key == "var":
        conf_dict = {
        ...
        msg = f"⌬ <b><u>משתני מערכת</u></b> | <b><u>עמוד {int(start / 10) + 1}</b></u>"
    elif key == "setonoff":
        for k in ONOFF_VARS:
            val = Config.get(k)
        ...
        msg = "⌬ <b><u>הפעלת רכיבים</u></b>\n\nסימון ✓ מציין שהרכיב פעיל."
    elif key == "private":
        if edit_mode:
        ...
        txt = "\n┠ ".join(
            [
                f"<code>{fn}</code> ← <b>{'קיים' if await aiopath.isfile(fn) else 'לא קיים'}</b>"
                for fn in [
                    "config.py",
                    "token.pickle",
                    "rclone.conf",
        ...
        msg = f"""⌬ <b>ניהול קבצים פרטיים</b>
┠ <b>מצב הקבצים</b>
┃
┠ {txt}
┃
┠ <b>מחיקת קובץ</b> ← שלחו את שמו כהודעת טקסט, לדוגמה <code>rclone.conf</code>.
┃
┖ <b>שימו לב:</b> שינוי ‎.netrc ישפיע על aria2c רק לאחר הפעלה מחדש."""
        if edit_mode:
            msg += "\n\n<i>למחיקה שלחו שם קובץ; לשמירה שלחו קובץ; וליצירת קובץ חדש השתמשו במבנה הבא.</i>\n\n<b>מבנה:</b>\n<code>file_name\n\ncontents of file</code>\n┖ <b>זמן שנותר:</b> <code>60 שניות</code>"
    elif key == "aria":
        ...
        msg = f"אפשרויות Aria2c | עמוד {int(start / 10)} | מצב: {'צפייה' if state == 'view' else 'עריכה'}"
    elif key == "qbit":
        ...
        msg = f"אפשרויות qBittorrent | עמוד {int(start / 10)} | מצב: {'צפייה' if state == 'view' else 'עריכה'}"
    elif key == "nzb":
        ...
        msg = f"אפשרויות SABnzbd | עמוד {int(start / 10)} | מצב: {'צפייה' if state == 'view' else 'עריכה'}"
    elif key == "nzbserver":
        servers = (
        ...
        msg = f"שרתי Usenet | עמוד {int(start / 10)} | מצב: {'צפייה' if state == 'view' else 'עריכה'}"
        ...
        msg = f"מפתחות השרת | עמוד {int(start / 10)} | מצב: {'צפייה' if state == 'view' else 'עריכה'}"
    else:
        msg = "האפשרות אינה מוכרת."
