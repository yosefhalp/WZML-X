...
class ProxyListener:
    ...
    @property
    def size(self):
        return getattr(self.multi_uploader.listener, "size", 0)

    @property
    def mid(self):
        return getattr(self.multi_uploader.listener, "mid", 0)

    @property
    def gofile_target_id(self):
        return getattr(self.multi_uploader.listener, "gofile_target_id", "")
